...
INSTALLED_APPS = [
    ...
    'multiselectfield',
    'storages',
    'dal', # Put these above django.contrib.admin to work with admin forms
    'dal_select2',   # Put these above django.contrib.admin to work with admin forms
]
...
ADMINS = ['bairavan@alchemdigital.com']
